...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        'filliny-fixed filliny-left-[50%] filliny-top-[50%] filliny-z-50 filliny-grid filliny-w-full filliny-max-w-[calc(100%-2rem)] filliny-translate-x-[-50%] filliny-translate-y-[-50%] filliny-gap-4 filliny-rounded-lg filliny-border filliny-bg-background filliny-p-6 filliny-shadow-lg filliny-duration-200 data-[state=open]:filliny-animate-in data-[state=closed]:filliny-animate-out data-[state=closed]:filliny-fade-out-0 data-[state=open]:filliny-fade-in-0 data-[state=closed]:filliny-zoom-out-95 data-[state=open]:filliny-zoom-in-95 sm:filliny-max-w-lg',
        className,
      )}
      {...props}>
      {children}
...
const DialogHeader = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
  <div
    className={cn('filliny-flex filliny-flex-col filliny-gap-2 filliny-text-center sm:filliny-text-left', className)}
    {...props}
  />
);
...
const DialogFooter = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
  <div
    className={cn(
      'filliny-flex filliny-flex-col-reverse filliny-gap-2 sm:filliny-flex-row sm:filliny-justify-end',
      className,
    )}
    {...props}
  />
