...
export const ModeDropdown: React.FC<ModeDropdownProps> = ({
  ...
  // Define base classes for dropdown options with glass design
  const optionBaseClasses =
    'filliny-py-2 filliny-px-3 filliny-cursor-pointer filliny-flex filliny-items-center filliny-w-full filliny-text-left filliny-border-none filliny-bg-transparent filliny-transition-all filliny-duration-200 filliny-ease-in-out filliny-text-white';

  const getOptionClasses = (isActive: boolean) =>
    cn(optionBaseClasses, isActive ? 'filliny-bg-white/10 filliny-font-bold' : 'hover:filliny-bg-white/5');

  const loadingSpinnerClasses =
    'filliny-inline-block filliny-w-3.5 filliny-h-3.5 filliny-rounded-full filliny-border-2 filliny-border-white/30 filliny-border-t-white filliny-animate-spin filliny-mr-2';

  return (
    <div
      ref={dropdownRef}
      className={cn(
        'filliny-fixed filliny-rounded-md filliny-shadow-lg',
        ...
        'filliny-text-sm filliny-text-white filliny-border filliny-border-white/10',
      ...
      <div
        className={cn(
          ...
          'filliny-border-b filliny-border-white/10 filliny-mb-1',
          'filliny-text-[13px] filliny-text-white',
        )}>
        Default Fill Mode
      </div>
      ...
      <button
        ...
        <div className="filliny-flex filliny-items-center">
          <svg
            ...
            stroke="currentColor"
            strokeWidth="2"
            className={cn('filliny-mr-2', preferTestMode && 'filliny-text-emerald-400')}>
