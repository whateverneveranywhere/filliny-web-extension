...
const PageLayout = ({ children, footer, isLoggedIn = true }: PageLayoutProps) => (
  <div className="filliny-flex filliny-min-h-screen filliny-h-full filliny-w-full filliny-flex-col filliny-bg-background filliny-overflow-auto filliny-relative">
    {isLoggedIn && <Header />}
